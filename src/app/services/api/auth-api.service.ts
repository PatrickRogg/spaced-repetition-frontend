...
export class AuthApiService {
  ...
  public signIn(userSignInRequestData: UserSignInRequestData) {
    return this.httpClient.post(this.AUTH_API_URL + 'sign-in', userSignInRequestData, this.header);
  }

  public signUp(userSignUpRequestData: UserSignUpRequestData) {
    return this.httpClient.post(this.AUTH_API_URL + 'sign-up', userSignUpRequestData, this.header);
  }
}
